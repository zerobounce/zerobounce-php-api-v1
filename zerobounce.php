...
class ZeroBounceAPI {
  private $key;
  private $baseURL = "https://api.zerobounce.net/v1/";
  ...
  */
  public function validate($email){
    return $this->api_call("validate",['email' => $email]);
  }
  /**
  *  wrapper for api_call/validate
  */
  public function validatewithip($email, $ip){
    return $this->api_call("validatewithip",["email" => $email, "ipAddress" => $ip]);
  }
}
